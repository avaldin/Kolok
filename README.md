...
> A real-time collaborative shared living (colocation) management Progressive Web App that simplifies roommate coordination through synchronized tools and passwordless authentication.

---

## Problem & Solution

**The Problem**: Roommates struggle to coordinate shared tasks like shopping lists, expenses, and schedules. Traditional apps require complex setups, passwords, and lack real-time synchronization.

**Our Solution**: Kolok provides a lightweight, passwordless PWA with real-time collaborative tools. Users authenticate via email verification codes, join shared "Koloks" (rooms), and access synchronized tools like shopping lists with instant updates and push notifications.
...
- **Passwordless Authentication**: Email-based login with 6-digit verification codes (15-minute expiration)
- **Automatic Email Delivery**: Powered by Resend for reliable transactional emails
...
- **WebSocket Synchronization**: Instant updates via Socket.IO for all room members
...
- **Shopping List**: Collaborative shopping list with real-time item additions/removals
...
**Modular Design**
- NestJS modules for clear separation of concerns (User, Room, Tools, Notifications)
- Each tool (shopping-list) is an independent module with its own entity, service, and controller
- Scalable architecture ready for additional tools (calendar, expenses, tasks, notes)
...
- Custom validation pipes for names (3-25 characters, alphanumeric + special chars)
...
- Implement JWT/session tokens instead of client-side userId storage
- Add rate limiting on verification code endpoints
...
- Test framework ready for unit and e2e tests

**Documentation**
- Swagger/OpenAPI documentation auto-generated from decorators
- Inline code comments for complex logic
- CLAUDE.md files for AI-assisted development context
...
This project follows conventional commits and uses migrations for database changes.
...
**Next Steps**: Additional collaborative tools, enhanced security, comprehensive testing

---

**Built with modern web technologies to solve real-world roommate coordination challenges.**
